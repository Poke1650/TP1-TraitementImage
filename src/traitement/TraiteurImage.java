...
public class TraiteurImage {
   ...
   * @return Le pixel dont sa couleur est la plus fréquente de l'image From :
   * https://stackoverflow.com/questions/8545590/ ...
   ...
   * est positif, l’image devient plus noire, si v est négatif, l’image devient
   * plus claire
   *
   * @param i
   * @param v
  ...
  /**
   * Extait une partie d'une image selon des coordonnées passées en paramètres.
   * L'image est extraite à partir du point (p1,c1) et du point (p2,c2).
  ...
  /**
   * Réduit l’image i1 pour produire l’image i2 en faisant la moyenne de la
   * valeur des groupes de quatres pixels pour en former un seul. Les pixels
   * formés constituent la nouvelle image
   *
   * @param i
  ...
  /**
   * Get la valeur moyenne des pixels en paramètres. Retourne un pixel avec
   * cette nouvelle valeur. Peut gérer un pixel RGB et un pixel noir et blanc.
   *
   * @param pixels ArrayList de pixels, c'est avec leur valeurs que nous
   * effectuons la moyenne
