 ...
 * @version 1.0
 *
 * Une matrice est un tableau à 2 dimensions. Cette patrice contient des pixels, utilisé pour lire, afficher et traiter des images.
 */
public class MatricePixel {
    ...
    /**
     * Construit la matrice avec sa hauteur et sa largeur. Les valeurs de la matrice sont à null
     *
     * @param height hauteur de la matrice
     * @param width largeur de la matrice
     */
    public MatricePixel(int height, int width) {

        this.width = width;
        this.height = height;

        matrice = new Pixel[height][width];       //construit la matrice
    }
     ...
     */
    public void setValue(int i, int j, Pixel value) {
        matrice[i][j] = value;
    }

    /**
     * Redimensionne la matrice avec une nouvelle hauteur et largeur. Recopie les valeurs de la matrice originale dans la nonuvelle matrice lorsque les dimensions le
     * permettent.
     *
     * @param height
     * @param width
    ...
    public void resize(int height, int width) {
        Pixel[][] newMat = new Pixel[height][width];            //nouvelle matrice
