 ...
 * @version 1.0
 * 
 * Une matrice est un tableau à 2 dimensions. Cette patrice contient des pixels, utilisé pour lire, afficher et 
 * traiter des images.
 */
public class MatricePixel {
    ...
    /**
     * Redimensionne la matrice avec une nouvelle hauteur et largeur. Recopie les valeurs
     * de la matrice originale dans la nonuvelle matrice lorsque les dimensions le permettent.
     * @param height
     * @param width 
     */
